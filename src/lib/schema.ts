...
export const schemaProduct = z.object({
  ...
  description: z
    ...
    .min(4, { message: "Description should have min 10 characters" }),
...
export const schemaShippingAddress = z.object({
  ...
  phone: z
    ...
    .min(12, { message: "Phone should have 12 minimal characters" }),
});
