...
export async function storeOrder(
  ...
  const validate = schemaShippingAddress.safeParse({
  ...
  try {
    ...
    const data: PaymentRequestParameters = {
      ...
      paymentMethod: {
        ewallet: {
          channelProperties: {
            successReturnUrl: process.env.NEXT_PUBLIC_REDIRECT_URL, // redirect ketika user berhasil bayar
          },
    ...
    await prisma.orderDetail.create({
      data: {
        ...
        postal_code: validate.data.postal_code,
